...
In this ciurse we already learned what are forms and how to manage its data. To be able to complete this exercise we recommend you to review [forms in HTML](https://refugees-code-material.netlify.app/html/contents#04-html-forms) and how to [manage DOM events](https://refugees-code-material.netlify.app/basic-js/contents#04-events-and-the-dom).
