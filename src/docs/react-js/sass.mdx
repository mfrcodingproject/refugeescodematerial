...
### style.scss
This file will garther all partial files that we will create and will be imported in the `index.js` file. 
```scss
...
You can declare a mixin like this:
...
````
Remeber to import your mixins with `@import` in the component partial file them before using them.
