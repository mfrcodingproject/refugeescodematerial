...
In this course we already learned about class and functional components in [section 1 - React.js] (Missing url). Functional components are functions that accept arguments as the properties of the component and return valid JSX, as shown below:
